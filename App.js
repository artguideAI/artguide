...
import AllArtwork from './screens/tabfour/AllArtwork'
import Artwork_info from './screens/tabfour/Artwork_info'
...
function MainTab() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="Main" component={SearchArt} />
...
function MuseumTab() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="SearchMuseum" component={SearchMuseum} />
...
function ArtworkTab() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="AllArtwork" component={AllArtwork} />
      <Stack.Screen name="Artwork_info" component={Artwork_info} />
    </Stack.Navigator>
  )
}
